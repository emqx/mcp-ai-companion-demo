...
EMQX MCP AI 语音助手的语音交互能力由火山引擎实时对话式 AI 服务提供。火山云负责 RTC 音视频传输、ASR 语音识别、TTS 语音合成等核心能力，开发者通过 CustomLLM 模式对接自有 AI 后端，实现语音驱动的智能交互。
...
火山云语音服务按使用量计费，各计费项均提供免费试用额度。详见 [对话式 AI 实时计费](https://www.volcengine.com/docs/6348/1392584)。
